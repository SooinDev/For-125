...
public class LiveStatusContentVO {
  ...
  public String getLiveImageUrl() {
    ...
    System.out.println("[DEBUG] getLiveImageUrl 호출 - liveImageUrl: " + liveImageUrl + ", channelId: " + channelId);
    if (liveImageUrl != null && !liveImageUrl.isEmpty()) {
      return liveImageUrl;
    }
    if (channelId != null && !channelId.isEmpty()) {
      String thumbnailUrl = "https://livecloud-thumb.akamaized.net/chzzk/" + channelId + "_720.jpg";
      System.out.println("[DEBUG] 생성된 썸네일 URL: " + thumbnailUrl);
      return thumbnailUrl;
    }
    System.out.println("[WARN] 썸네일 URL 생성 실패 - channelId가 null");
    return null;
  }
